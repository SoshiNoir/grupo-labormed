...
const PaternityTest = () => {
  return (
    <PageShell
      eyebrow='Teste de paternidade'
      title='Sigilo, precisão e clareza apresentados em linguagem visual mais atual.'
      description='A página foi reorganizada em cards translúcidos para transmitir seriedade sem parecer pesada.'
      imageSrc='/paternitytest.png'
      imageAlt='Teste de paternidade'
    >
